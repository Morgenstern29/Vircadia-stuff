...
(function () {
    ...
    var OVERLAY_SITTABLE_DISTANCE_SHOW_M = 10; // m 
    var OVERLAY_SITTABLE_DISTANCE_MAX_M = 10; // m
    var OVERLAY_SITTABLE_START_ALPHA = 1.0;
    var OVERLAY_SITTABLE_MIN_END_ALPHA = 0.7; // fades to this alpha value
    ...
    var ANIMATION_LAST_FRAME = 163; //Change frames here depends of your animation.
